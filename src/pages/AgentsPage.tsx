    ...
    return (
        ...
        >
            <div className="glass p-12 rounded-[3.5rem] relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="text-center md:text-left">
                        <h1 className="text-5xl md:text-6xl font-black tracking-tighter mb-4 text-white">Mentes <span className="text-primary italic">Maestras</span></h1>
            ...
            <div className="space-y-8">
                <h2 className="text-3xl font-bold flex items-center gap-3 mb-8 text-white">
              ...
              `}>
                            ...
                            <span className="font-bold text-sm tracking-tight leading-tight block text-white">{niche.name}</span>
                        </motion.div>
                    ))}
                </div>
            </div>
                                ...
                                <div className="flex items-center gap-5">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className="bg-transparent border-none font-extrabold text-2xl tracking-tight focus:ring-0 w-full text-white"
                                        />
